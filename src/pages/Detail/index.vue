<template>
  <div class="detail">
          ...
          <div class="goodsDetail">
            ...
            <div class="priceArea">
              <div class="priceArea1">
                ...
                <div class="price"> <i>¥</i><em>{{ skuInfo.price }}</em><span>降价通知</span></div>
                <div class="remark"><i>累计评价</i><em>65545</em></div>
              </div>
              <div class="priceArea2">
                <div class="title"><i>促&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;销</i></div>
                <div class="fixWidth">
    ...
    <section class="product-detail">
      <aside class="aside">
        <div class="tabWraped"><h4 class="active">相关分类</h4><h4>推荐品牌</h4></div>
        <div class="tabContent">
          <div class="tab-pane active">
            <ul class="partList">
              <li>手机</li><li>手机壳</li><li>内存卡</li><li>Iphone配件</li><li>贴膜</li><li>手机耳机</li><li>移动电源</li><li>平板电脑</li>
            </ul>
            <ul class="goodsList">
              <li>
                <div class="list-wrap">
                  <div class="p-img"><img src="./images/part01.png" /></div>
                  <div class="attr">Apple苹果iPhone 6s (A1699)</div>
                  <div class="price"><em>¥</em><i>6088.00</i> </div>
                  <div class="operate">
...
export default {
  ...
  methods: {
    ...
    //表单元素修改产品个数
    changeSkuNum() {
      let value = this.skuNum * 1; //用户输入进来的文本 * 1
      if (isNaN(value) || value < 1) { //如果用户输入进来的非法,出现NaN或者小于1
        this.skuNum = 1;
      } else {
        this.skuNum = parseInt(value); //正常大于1【大于1整数不能出现小数】
      }
    },
    //加入购物车
    async addShopcar(){
